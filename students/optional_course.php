...
<head>
    ...
    <script type="text/javascript">
        function bbb(){
            ...
            if(text=='') {
                alert("请输入页号！");
                window.location.href="optional_course.php?p=1";
...
<body>
<div id="contentWrap">
    <div class="pageTitle">&nbsp;&nbsp;<span>当前位置 -- 网上选课 -- 选修课</span></div>
    <div class="pageColumn">
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="optional_course1.php?selectcourse=<?php echo $rows['课程编号']?>"><input style="border:1px solid #bfd8e0;width:40px;height:20px" type="button" name="select_course" value="选课"></a></td>
            </tr>
            <?php $i++;endforeach;?>
            </tbody>
        </table>
        ...
        $page_banner.="<form action='optional_course.php' method='get'>";
