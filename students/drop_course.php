...
// echo $_SESSION['user'];
$user=$_SESSION['id'];
$total_sql="select count(*) from (select curricula.Id as '课程编号',curricula.Name as '课程名称',curricula_type.Name as '课程性质',curricula.Credit as '学分',curricula.Hours as '学时',speciality.Name as '专业',academy.Name as '学院',curricula.Contain as '课程容量',teacher.Name as '任课教师',building.Name as '教学楼',classroom.Id as '教室',shouke.Start_week as '开始上课周',shouke.End_week as '结束上课周',shouke.Day as '上课时间',shouke.Start_class as '开始上课时间',shouke.End_class as '结束上课时间' from curricula,curricula_variable,curricula_type,speciality,academy,teacher,building,classroom,shouke where curricula.Speciality_Id=speciality.Id and curricula_variable.Curricula_Id=curricula.Id and curricula_variable.Student_Id='$user' and curricula.Academy_Id=academy.Id and curricula.Type=curricula_type.Id and shouke.Curricula_Id=curricula.Id and shouke.Building_Id=building.Id and shouke.Classroom_Id=classroom.Id and classroom.Building_Id=building.Id and shouke.Teacher_Id=teacher.Id and curricula_type.Name!='专业必修' and curricula_type.Name!='公共基础必修' and curricula_type.Name!='实践环节必修') sc";
$total_result=mysqli_fetch_array(mysqli_query($conn,$total_sql));
$total=$total_result[0];
$total_pages=ceil($total/$pageSize);
$page=$_GET['p'];
if($page>$total_pages+1){
    echo "<script>alert('无此页'); window.location.href=\"drop_course.php?p=1\";
                window.event.returnValue = false;</script>";
}
$showPage=5;
$start=($page-1)*$pageSize;
$sql1="select curricula.Id as '课程编号',curricula.Name as '课程名称',curricula_type.Name as '课程性质',curricula.Credit as '学分',curricula.Hours as '学时',speciality.Name as '专业',academy.Name as '学院',curricula.Contain as '课程容量',teacher.Name as '任课教师',building.Name as '教学楼',classroom.Id as '教室',shouke.Start_week as '开始上课周',shouke.End_week as '结束上课周',shouke.Day as '上课时间',shouke.Start_class as '开始上课时间',shouke.End_class as '结束上课时间' from curricula,curricula_variable,curricula_type,speciality,academy,teacher,building,classroom,shouke where curricula.Speciality_Id=speciality.Id and curricula_variable.Curricula_Id=curricula.Id and curricula_variable.Student_Id='$user' and curricula.Academy_Id=academy.Id and curricula.Type=curricula_type.Id and shouke.Curricula_Id=curricula.Id and shouke.Building_Id=building.Id and shouke.Classroom_Id=classroom.Id and classroom.Building_Id=building.Id and shouke.Teacher_Id=teacher.Id and curricula_type.Name!='专业必修' and curricula_type.Name!='公共基础必修' and curricula_type.Name!='实践环节必修' limit {$start},{$pageSize}";
...
<head>
    ...
    <script type="text/javascript">
        function bbb(){
            ...
            if(text=='') {
                alert("请输入页号！");
                window.location.href="drop_course.php?p=1";
...
<body>
<div id="contentWrap">
    <div class="pageTitle">&nbsp;&nbsp;<span>当前位置 -- 网上选课 -- 退课</span></div>
    <div class="pageColumn">
        <div class="pageButton" style="text-align:center">学生退课界面</div>
        <table>
            <thead>
            <th>课程编号</th>
            <th>课程名称</th>
            ...
            <tr>
                ...
                <td><a href="drop_course1.php?selectcourse=<?php echo $rows['课程编号']?>"><input style="border:1px solid #bfd8e0;width:40px;height:20px" type="button" name="select_course" value="退课"></td></a>
            </tr>
            <?php $i++;endforeach;?>
            </tbody>
        </table>
        ...
        $page_banner.="<form action='drop_course.php' method='get'>";
