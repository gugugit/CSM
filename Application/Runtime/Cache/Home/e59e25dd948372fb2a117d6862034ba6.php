...
<html>
    ...
    <body>
        <div class="tab-content" id="tab2">
            <div class="crumb-list"><i class="icon-font"> </i><a href="/new_new_management_system/index.php/Home/Stumanage/../Index/main">首页 </a><span class="crumb-step">&gt;</span><span class="crumb-name">添加学生信息</span></div>

          <form action="/new_new_management_system/index.php/Home/Stumanage/add" method="post"id="checkname">
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <table class="insert-tab" width="100%">
            <tbody><tr>
              <th width="150"><label>ID&nbsp&nbsp</label></th>
              <td><input value = "<?php echo ($stuid); ?>" name="stuid" /></td>
          </tr>
            <tr>
              <th><label>姓名&nbsp</label></th>
              <td><input value="<?php echo ($stuname); ?>" name="stuname" /></td>
          </tr>
            <tr>
              <th><label>性别&nbsp</label></th>
              <td><select value="<?php echo ($stusex); ?>" name="stusex" >
            ...
            <tr>
              ...
              <td><input class="text-input" type="text" id="large-input" value = "<?php echo ($stubirthplace); ?>" name="stubirthplace" /></td>
          </tr>
            <tr>
            ...
            <tr>
                ...
                <td><select name = 'stupermission'>
                    <option value='3' <?php echo ($p3); ?>>本科生</option>
                    <option value='4' <?php echo ($p4); ?>>研究生</option>
                    <option value='5' <?php echo ($p5); ?>>博士生</option>
                </select></td>
            </tr>
            <tr>
              <th></th>
              <td><input class="btn btn-primary btn6 mr10"onClick="return check()" type="submit" value="确认添加" /><input class="btn btn6" onclick="history.go(-1)" value="返回" type="button"></td>
          </tr>
            <div class="clear"></div>
        </tbody>
        </table>
