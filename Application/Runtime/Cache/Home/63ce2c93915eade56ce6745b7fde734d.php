...
<div class="pageColumn">
		<div style="margin-left:90%"><a href="/CSM/index.php/Home/Sysmessage/add"><h2><font size="3" color="green">添加系统消息</font></h2></a></div>
<div class="pageButton"></div>
	<table>
      ...
      <tbody>
          ...
          <td><a href="/CSM/index.php/Home/Sysmessage/read/id/<?php echo ($vo['id']); ?>"><font color="green"><?php echo ($vo['title']); ?></font></a></td>
          <td>
  			<a href="/CSM/index.php/Home/Sysmessage/edit/id/<?php echo ($vo['id']); ?>" title="编辑"><img src="/CSM/Public/Images/admin/icons/pencil.png" alt="编辑" /></a>
  			<a href="/CSM/index.php/Home/Sysmessage/delete/id/<?php echo ($vo['id']); ?>" title="删除"><img src="/CSM/Public/Images/admin/icons/cross.png" alt="删除" /></a>
		</td>
