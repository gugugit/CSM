...
<div id="contentWrap">
    ...
    <div class="pageColumn"><form method="post" action="/Educational_Administration_System/View/index.php/Home/Currmanage/search" id="search">
        按照Id查询课程<input type="text" id="sid" name="searchid"/> 按照名称查询课程 <input type="text" id="sname" name="searchname"/>
        <input class="btn btn-primary btn6 mr10"  type="submit" value="查询" /><div style="margin-left:90%"><a href="/Educational_Administration_System/View/index.php/Home/Currmanage/add"><h2><font size="3" color="green">添加课程信息</font></h2></a></div>
        ...
        <table>
            ...
            <?php if(is_array($curricula_list)): $i = 0; $__LIST__ = $curricula_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <!--<td><a href="/Educational_Administration_System/View/index.php/Home/Currmanage/read/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a></td>-->
                    <td>
                        <a href="/Educational_Administration_System/View/index.php/Home/Currmanage/edit/id/<?php echo ($vo['id']); ?>" title="编辑"><img src="/Educational_Administration_System/View/Public/Images/admin/icons/pencil.png" alt="编辑" /></a>
                        <a href="/Educational_Administration_System/View/index.php/Home/Currmanage/delete/id/<?php echo ($vo['id']); ?>" title="删除"><img src="/Educational_Administration_System/View/Public/Images/admin/icons/cross.png" alt="删除" /></a>
                    </td>
