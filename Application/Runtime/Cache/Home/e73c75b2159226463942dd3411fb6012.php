...
<div id="contentWrap">
    ...
    <div class="pageColumn"><form method="post" action="/Educational_Administration_System/View/index.php/Home/Tecmanage/search" id="search">
        按照Id查询教师<input type="text" id="sid" name="searchid"/> 按照姓名查询教师 <input type="text" id="sname" name="searchname"/>
        <input class="btn btn-primary btn6 mr10" type="submit" value="查询" /><div style="margin-left:90%"><a href="/Educational_Administration_System/View/index.php/Home/Tecmanage/add"><h2><font size="3" color="green">添加教师信息</font></h2></a></div>
