...
<div id="contentWrap">
    ...
    <div class="pageColumn">
        <form method="post" action="/Educational_Administration_System/View/index.php/Home/Currmanage/search" id="search">
        ...
        <div style="margin-left:90%"><a href="/Educational_Administration_System/View/index.php/Home/Currmanage/add"><h2><font size="3" color="green">添加课程信息</font></h2></a></div>
