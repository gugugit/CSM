...
if($page>$total_pages+1){
    echo "<script>alert('无此页'); window.location.href=\"teacherInfo1.php?p=1\";
                window.event.returnValue = false;</script>";
}
$showPage=5;
$start=($page-1)*$pageSize;
$sql="select teacher.Id as teacherId,teacher.Name as teacherName,Sex,Password,speciality.Name as SpecialityName,academy.Name as AcademyName,Phone,Identification_Card,Nation,BirthPlace,BirthDay from teacher,speciality,academy where teacher.Speciality = speciality.Id and teacher.Academy=academy.Id limit {$start},{$pageSize}";
...
<head>
    ...
    <script type="text/javascript">
        function bbb(){
            ...
            if(text=='') {
                alert("请输入页号！");
                window.location.href="teacherInfo1.php?p=1";
...
<body>
<div id="contentWrap">
    <div class="pageTitle">&nbsp;&nbsp;<span>当前位置 -- 报表统计查询 -- 教师信息查询</span></div>
    <div class="pageColumn">
        <div class="pageButton"><h1 style="text-align:center">&nbsp;&nbsp;教师信息查询统计表</h1></div>
        <table>
            <thead>
            <th >教工号</th>
            <th >教师姓名</th>
