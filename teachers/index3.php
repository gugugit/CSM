...
$result = mysqli_query($conn,"SELECT curricula.Name,building.Name,Start_class,End_class,shouke.Classroom_Id,shouke.Day,shouke.Start_week,shouke.End_week FROM shouke,speciality,curricula,building where shouke.Curricula_Id=curricula.Id and curricula.Speciality_Id = speciality.Id and speciality.Name = '$zy' and building.Id=shouke.Building_Id ");
$sum=array();
$pos;
